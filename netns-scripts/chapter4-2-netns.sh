...
# host1のリンクの設定
ip netns exec host1 sysctl -w net.ipv6.conf.all.disable_ipv6=1
...
# router1のリンクの設定
ip netns exec router1 sysctl -w net.ipv6.conf.all.disable_ipv6=1
...
# router2のリンクの設定
ip netns exec router2 sysctl -w net.ipv6.conf.all.disable_ipv6=1
...
# host2のリンクの設定
ip netns exec host2 sysctl -w net.ipv6.conf.all.disable_ipv6=1
...
# router3のリンクの設定
ip netns exec router3 sysctl -w net.ipv6.conf.all.disable_ipv6=1
